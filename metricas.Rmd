...
Para incluir cálculos de diferentes métricas de paisagem ao mesmo tempo, precisamos somente acrescentar uma linha de codigo, que cria um objeto com os nomes das métricas que queremos calcular..... Assim, precisamos usar a opção 
"what" na função para aceitar os nomes. 

```{r, echo=TRUE, message=FALSE, warning=FALSE}
# Objeto com os nomes das funções para calcular as métricas desejadas.
minhas_metricas <- c("lsm_c_pland", "lsm_c_ed", "lsm_c_cpland", 
                     "lsm_c_enn_mn", "lsm_c_enn_sd", "lsm_c_enn_cv", "lsm_c_pd","lsm_c_cohesion")
...
# fazer grafico
  ...
  labs(title = "Resultados de várias métricas",
    x = "extensão (quilômetros)", 
    y = "metric value")
```
