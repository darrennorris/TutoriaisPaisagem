...
amostras_metrica %>% 
  ...
  mutate(proporcao_floresta = 
         ...
         porcentagem_floresta = 
           round((area_floresta_ha / area_total_ha)*100, 1)) -> amostra_metrica_resumo
```

## Make a graph
```{r}
amostra_metrica_resumo %>% 
...
minhas_metricas <- c("cpland", "ed", "pladj", "cohesion")
