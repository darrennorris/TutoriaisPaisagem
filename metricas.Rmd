...
Para incluir cálculos de diferentes métricas de paisagem ao mesmo tempo, precisamos somente acrescentar uma linha de codigo, que cria um objeto com os nomes das métricas que queremos calcular..... Assim, tambem precisamos usar a opção "what" na função para aceitar os nomes. 
